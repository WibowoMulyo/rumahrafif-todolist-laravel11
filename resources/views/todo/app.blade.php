                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-group mb-4" id="todo-list">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                @php
                                    $status = $item->is_done == '1' ? 'del' : 'span';
                                @endphp
                                <{{ $status }} class="task-text">{{ $item->task }}</{{ $status }}>
                                ...
                                <div class="btn-group">
                                    ...
                                    <button class="btn btn-primary btn-sm edit-btn" data-bs-toggle="collapse"
                                        data-bs-target="#collapse-{{ $item->id }}" aria-expanded="false">✎</button>
                                </div>
                            </li>
                            <!-- 05. Update Data -->
                            <li class="list-group-item collapse" id="collapse-{{ $item->id }}">
